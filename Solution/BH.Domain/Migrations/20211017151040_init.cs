    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Domains", x => x.DomainType);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MachineId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DomainType = table.Column<int>(nullable: false),
                    LockedByUserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.DomainType,
                        principalTable: "Domains",
                        principalColumn: "DomainType",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Machines_AspNetUsers_LockedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Machines_LockedByUserId",
                table: "Machines",
